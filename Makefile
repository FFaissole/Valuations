...
# coq_makefile Models/Compactness.v Models/Cpo.v Models/Dominance.v Models/wCpo_compl.v Probas/Flip.v Probas/Giry.v Probas/Interp.v Probas/Programs.v Probas/Random.v Probas/RandomWalk.v Probas/S_compute_tac.v Probas/U01.v Spaces/Functions.v Spaces/Opens.v Spaces/RoundedClosed.v Spaces/Subopens.v Theories/D_op.v Theories/LowerIntegrals.v Theories/OpenFun.v Theories/Riesz1.v Theories/Riesz2.v Theories/Valuations.v -o Makefile 
#
...
vo_to_obj = $(addsuffix .o,\
  ...
  $(shell $(COQBIN)coqtop -noinit -batch -quiet -print-mod-uid $(1))))
...
VFILES:= Models/Cpo.v\
  Spaces/RoundedClosed.v\
  Spaces/Opens.v\
  Models/Compactness.v\
  Models/Dominance.v\
  Models/wCpo_compl.v\
  Spaces/Functions.v\
  Spaces/Subopens.v\
...
gallinahtml: $(GLOBFILES) $(VFILES)
	- mkdir -p html
	$(COQDOC) -toc $(COQDOCFLAGS) -html -l $(COQDOCLIBS) -d html $(VFILES)
